defmodule Lipu.BuildDictionary do
  ...
  def build(csv_list) do
    all = %{alternates: alternates, tp_lemmas: tp_lemmas_without_alternates} = Enum.reduce(csv_list, @accumulator, &Lipu.BuildDictionary.reduce/2)
    ...
    tp_lemmas = Enum.concat(tp_lemmas_without_alternates, alternate_tp_lemmas)

    %{all | tp_lemmas: tp_lemmas }
  end
end
