...
export const getEnWord = (state: EnWordsState, id: EnWordId): EnWord =>
  state[id];
...
export const word = ({ text, pos, id }: EnLemma): IncidentalEnWord => ({
  lemmaId: id,
  text,
  pos,
  id: v4(),
...
export const newPlaceholder = (
  ...
  text: string,
  tpWordId: WordId
): EnWordPlaceholder => ({ id: enWordId, text, pos: "prop", tpWordId });
